export default function PrivacyPolicy() {
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 dark:bg-gray-800 dark:text-gray-200 text-left">
            <div className="mx-auto max-w-4xl px-6 py-12">
                ...
                <div className="space-y-8 leading-relaxed">
                    ...
                    <p>
                        ...
                        and protected when you use the application.
                    </p>
                    ...
                    <section>
                        ...
                        <p>
                            When you sign in using Google OAuth, we may collect limited profile
                            information such as your name, email address, and profile picture.
                            This data is used strictly for authentication and account
                            management.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc space-y-1 pl-6">
                            ...
                            <li>Images may be visible to others based on platform features</li>
                    ...
                    <section>
                        ...
                        <p>
                            Lumen Captures also displays publicly available images sourced from
                            Unsplash for browsing and exploration. These images are not owned
                            by Lumen Captures and remain subject to Unsplash’s licensing terms.
                        </p>
                    </section>

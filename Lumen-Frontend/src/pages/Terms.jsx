        ...
        <div className=" text-gray-800  dark:text-gray-100  ">
            <main className="max-w-4xl mx-auto px-6 py-12">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">1. Purpose</h2>
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">2. Use of the Platform</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">3. User-Uploaded Content</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">4. Content Policy</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">5. Sample Images</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                        Lumen Captures may display sample images from Unsplash under the Unsplash License for demonstration purposes only. Ownership remains with the original photographers.
                    </p>
                </section>

                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">6. Image Downloads</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">7. User Information</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">8. Privacy & Data Usage</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">9. Limitation of Liability</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">10. Account Termination</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-bold mb-2  text-left">11. Changes to These Terms</h2>
                    <p className=" text-gray-800 dark:text-gray-100  text-left">
